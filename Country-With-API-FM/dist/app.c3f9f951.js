...
function renderHome(countryHome) {
  ...
  var _iterator = _createForOfIteratorHelper(countryHome),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var value = _step.value;
      var homeHTML = "<div class=\"card\" data-code=\"".concat(value.name, "\">\n      <div class=\"card__img\">\n        <img src=\"").concat(value.flag, "\" alt=\"").concat(value.name, "\">\n      </div>\n      <div class=\"card__desc\">\n        <div class=\"card__desc-title\">\n          <p>").concat(value.name, "</p>\n        </div>\n        <div class=\"card__desc-con\">\n          <p><span>Population:</span>").concat(value.population, "</p>\n          <p><span>Region:</span>").concat(value.region, "</p>\n          <p><span>Capital:</span>").concat(value.capital, "</p>\n        </div>\n      </div>\n    </div>");
  ...
  allCards.forEach(function (items) {
    items.addEventListener("click", function () {
      window.location.hash = "#".concat(items.dataset.code);
    });
  });
...
function fetchCountry() {
  return _axios.default.get("".concat(cors).concat(baseURL, "/all")).then(function (result) {
    countryData = [];
...
function fetchIndividualCountry(extraParam) {
  ...
  return _axios.default.get("".concat(cors).concat(baseURL, "/name/").concat(extraParam, "?fullText=true")).then(function (indiCountry) {
...
function fetchCountryCode(code) {
  return _axios.default.get("".concat(cors).concat(baseURL, "alpha/").concat(code)).then(function (indiCountry) {
...
function renderIndiHTML(data) {
  ...
  if (data.borders.length !== 0) {
    var _iterator3 = _createForOfIteratorHelper(data.borders),
        _step3;

    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        var value = _step3.value;
        indibutton.push("<p class=\"indi__details--border--btn\" data-border=".concat(value, ">").concat(value, "</p>"));
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
    ...
    indibutton.push("<p class=\"indi__details--border--error\">No border for this Country</p>");
  }

  var _iterator4 = _createForOfIteratorHelper(data.currencies),
      _step4;
  ...
  var _iterator5 = _createForOfIteratorHelper(data.languages),
      _step5;
  ...
  buttonGroup.forEach(function (items) {
    items.addEventListener("click", function (e) {
      window.location.hash = "#".concat(items.dataset.border);
    });
  });
...
function renderHTML(hashValue) {
  ...
  if (hashValue === "#home") {
    ...
    fetchCountry().then(function (result) {
      renderHome(result);
    }).catch(function (err) {
      console.log(err);
    });
    ...
    if (changedHash.length === 3) {
      ...
      fetchCountryCode(changedHash).then(function (dataCode) {
...
filter.addEventListener("click", function (e) {
  ...
  totalRegions.forEach(function (items) {
    var ulHtml = " <li class=\"search__region-ul-li\" data-region = \"".concat(items, "\"><span>").concat(items, "</span></li>");
...
dark.addEventListener("click", function () {
  ...
  document.documentElement.style.setProperty("--dmb-element", " hsl(0, 0%, 100%)");
  document.documentElement.style.setProperty("--dmvb-backgroud", " hsl(0, 0%, 98%)");
  document.documentElement.style.setProperty("--dmw-text", "hsl(200, 15%, 8%)");
});
light.addEventListener("click", function () {
  light.style.display = "none";
  dark.style.display = "flex";
  document.documentElement.style.setProperty("--dmb-element", "hsl(209, 23%, 22%)");
  document.documentElement.style.setProperty("--dmvb-backgroud", "  hsl(207, 26%, 17%)");
